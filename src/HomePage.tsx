...
const HomePage: React.FC = () => {
    ...
    <p>I have a preference for backend but am currently working on improving my frontend skills. I have experience in C#, .NET Core, Python, SQL Server, SSIS and more.</p>
    <p>This website (more specifically my Medium page) is a place for me to post my musings on technology, personal projects, and anything I find interesting.</p>
        
    <p>If you found anything useful on my site, or even if you choose not to click any other link, then please click one of the links below. It could make a real difference.</p></div>
